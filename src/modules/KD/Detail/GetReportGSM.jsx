  ...
  */
  ...
  const handleSubmit = () => {
    setResult("");
      ...
      axios
        .get(
          `${urlBase}/api/kd/bao-cao-gsm?optionTool=${optionTool}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "multipart/form-data",
    ...
    <div>
      ...
      <div className="container">
        ...
        <div id="download-button-sale-order">
          {result ? (
            <div>
              <p>Click down below to download BaoCaoGSM.XLSX</p>
              <button
                className="btn btn-info"
                onClick={() => handleDownload(result)}
              >
                Download BaoCaoGSM.XLSX
              </button>
            </div>
          ) : (
            ""
