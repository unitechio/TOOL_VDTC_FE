  ...
  */
  ...
  const handleSubmit = () => {
    ...
    if (startTime === "" || endTime === "" || startTime > endTime) {
      ...
      axios
        .get(
          `${urlBase}/api/kd/bao-cao-sms?startTime=${startTime}&endTime=${endTime}&optionTool=${optionTool}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "multipart/form-data",
    ...
    <div>
      ...
      <div className="container">
        ...
        <div id="download-button-sale-order">
          {result ? (
            <div>
              <p>Click down below to download Báo cáo đấu đè VETC.XLSX</p>
              <button
                className="btn btn-info"
                onClick={() => handleDownload(result)}
              >
                Download Báo cáo đấu đè VETC.XLSX
              </button>
            </div>
          ) : (
            ""
...
export default BaoCaoDauDeVETC;
