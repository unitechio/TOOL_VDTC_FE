...
function HienTrangLienKetNguonTien() {
    ...
    */
    ...
    const handleSubmit = () => {
        ...
        // } else {
            ...
            const dummyDate = new Date('2025-01-01').toString().substring(0, 24);

            setShowLoading(true);
            // setResult("");
            axios
                .get(
                    `${urlBase}/api/kd/get-report-by-sql?startTime=${dummyDate}&endTime=${dummyDate}&optionTool=${optionTool}`,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            "Content-Type": "multipart/form-data",
    ...
    return (
        <div>
            ...
            <div className="container" style={{ textAlign: "left" }}>
                <h2 className="text-center m-3">Hiện trạng liên kết nguồn tiền</h2>
                <div className="form-search1 mt-5" style={{ marginLeft: "70px" }}>
                    <div className="form-searchDate row">
                        <div className="col-2 mt-1">
                            <h6 className="text-danger">Xuất báo cáo </h6>
                        </div>
...
export default HienTrangLienKetNguonTien;
