...
function KTCN() {
  ...
  useEffect(() => {
    axios
      .get(`${urlBase}/api/tool-department/getByGroupId?groupId=6`, {
        headers: {
    ...
    <div className="custom-bg-container">
      ...
      <div className="container">
        <h2 className="text-center text-primary">
          Chào mừng bạn đến với trang Kỹ thuật công nghệ
        </h2>
              ...
              <div className="card border-bottom rounded border-warning">
                <div className="card-body">
                  ...
                  >
                    ...
                    {tool.option_tool === "Quét hóa đơn billing chưa được cấp lại mã của Cơ Quan Thuế khi xuất hiện cảnh báo" ? (
                      <Link
                        to={`/KTCN/scan-billing/${tool.id}`}
                        className="btn btn-outline-primary"
                      >
                        Xem chi tiết
                      </Link>
