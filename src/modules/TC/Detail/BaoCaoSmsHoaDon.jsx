    ...
    */
    ...
    const handleSubmit = () => {
        ...
        if (startTime === "" ) {
            ...
            axios
                .get(
                    `${urlBase}/api/tc/bao-cao-sms-hoa-don?startTime=${startTime}&optionTool=${optionTool}`,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            "Content-Type": "multipart/form-data",
    ...
    return (
        <div>
            ...
            <div className="container" style={{ textAlign: "left" }}>
                <h2 className="text-center m-3">Báo cáo sản lượng sms kèm số hóa đơn</h2>
...
export default BaoCaoSmsHoaDon;
