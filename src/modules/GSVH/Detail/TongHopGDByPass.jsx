  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        Tổng hợp giao dịch truy thu bypass
        </h2>
        <div>
          Start Date:{" "}
          <input
        ...
        <div id="download-button-sale-order">
          {result ? (
            <div>
              <p>Click down below to download TongHopGDByPass.XLSX</p>
              <button
                className="btn btn-info"
                onClick={() => handleDownload(result)}
              >
                Download TongHopGDByPass.XLSX
              </button>
            </div>
          ) : (
            ""
...
export default TongHopGDByPass;