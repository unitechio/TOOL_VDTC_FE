    ...
    function DoiSoatNgayFPTPay() {
        ...
        const minDate = new Date(today.getTime() - 1 * 24 * 60 * 60 * 7000); // Ngày hiện tại trừ đi 7 ngày
        ...
        */
        ...
        const handleSubmit = () => {
            ...
            if (startTime === "" || endTime === "" || endTime < startTime ) {
                ...
                axios
                    .get(
                        `${urlBase}/api/gsvh/search-fpt-pay?startTime=${startTime}&endTime=${endTime}&optionTool=${optionTool}&other=${vehicleNumber}`,
                        {
                            headers: {
                                Authorization: `Bearer ${token}`,
                                "Content-Type": "multipart/form-data",
        ...
        return (
            <div>
                ...
                <div className="container" style={{ textAlign: "left" }}>
                    <h2 className="text-center m-3">Đối soát ngày FPT PAY</h2>
    ...
    export default DoiSoatNgayFPTPay;
