...
function ReportCollectionTransaction() {
    ...
    */
    ...
    const handleSubmit = () => {
        ...
        if (startTime === "" || endTime === "" || endTime < startTime ) {
            ...
            axios
                .get(
                    `${urlBase}/api/gsvh/get-report-by-sql?startTime=${startTime}&endTime=${endTime}&optionTool=${optionTool}`,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            "Content-Type": "multipart/form-data",
    ...
    return (
        <div>
            ...
            <div className="container" style={{ textAlign: "left" }}>
                <h2 className="text-center m-3">Báo cáo giao dịch truy thu </h2>
...
export default ReportCollectionTransaction;
