    ...
    */
    ...
    const handleSubmit = async () => {
        ...
        if (startTime === "" || endTime === "" || endTime < startTime) {
            ...
            setShowLoading(true);
            setResult("");
            const exportReportError = async () => {
                try {
                    const res = await API.exportReportError(token, startTime, endTime, optionTool);
                    setResult(res.data);
                } catch (err) {
                    console.log(err);
                }
            }
            await exportReportError()
    ...
    return (
        <div>
            ...
            <div className="container" style={{ textAlign: "left" }}>
                <h2 className="text-center m-3">Thống kê lỗi đối soát</h2>
                <div className="form-search1 mt-5" style={{ marginLeft: "70px" }}>
                    <div className="form-searchDate row">
                        ...
                        <div className=" col-1">
                            <button
                                className="button_search border-bottom mb-2"
