    ...
    */
    ...
    const handleSubmit = () => {
        ...
        if (startTime === "" || endTime === "" || endTime < startTime ) {
            ...
            axios
                .get(
                    `${urlBase}/api/gsvh/get-report-acv?startTime=${startTime}&endTime=${endTime}&other=${other}&optionTool=${optionTool}`,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            "Content-Type": "multipart/form-data",
    ...
    return (
        <div>
            ...
            <div className="container" style={{ textAlign: "left" }}>
                <h2 className="text-center m-3">Báo cáo Road_Parking </h2>
                    ...
                    <div className="form-searchDate row">
                        ...
                        <div className="col-2">
                                    <input
                                        ...
                                        type="text"
                                        placeholder="Nhập plate"
                                        onChange={(e) => {
                                            setOther(e.target.value.toLocaleUpperCase().trim())
                                        }}
                                    />
                                </div>
