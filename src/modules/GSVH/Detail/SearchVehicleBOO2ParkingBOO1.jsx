...
function SearchVehicleBOO2ParkingBOO1() {
    ...
    */
    ...
    const handleSubmit = () => {
        ...
        if (startTime === "" || endTime === "" || endTime < startTime ) {
            ...
            axios
                .get(
                    `${urlBase}/api/gsvh/search-vehicle-BOO2-connect-parking-BOO1?startTime=${startTime}&endTime=${endTime}&optionTool=${optionTool}&other=${vehicleNumber}`,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            "Content-Type": "multipart/form-data",
    ...
    return (
        <div>
            ...
            <div className="container" style={{ textAlign: "left" }}>
                <h2 className="text-center m-3">Báo cáo giao dịch thanh toán </h2>
                        ...
                        <div className="row d-flex justify-content-center mt-5">

                            {
                                result ?
                                    ...
                                    >
                                       TraCuuXeBOO2TruLienThongBaiDoBOO1.XLSX
                                    </button> :
                                    <div></div>
                            }
                        </div>
...
export default SearchVehicleBOO2ParkingBOO1;