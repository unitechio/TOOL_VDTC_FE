...
function DoiSoatLienThongBaiDo() {
    ...
    const minDate = new Date(today.getTime() - 7 * 24 * 60 * 60 * 1000); // Ngày hiện tại trừ đi 1 ngày
    ...
    */
    ...
    const handleSubmit = () => {
        ...
        if (startTime === "" || endTime === "" || endTime < startTime ) {
            ...
            axios
                .get(
                    `${urlBase}/api/gsvh/get-report-by-many-sql?startTime=${startTime}&endTime=${endTime}&optionTool=${optionTool}&other=${vehicleNumber}`,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            "Content-Type": "multipart/form-data",
    ...
    return (
        <div>
            ...
            <div className="container" style={{ textAlign: "left" }}>
                <h2 className="text-center m-3">Đối soát liên thông bãi đỗ</h2>
                        ...
                        <div className="row d-flex justify-content-center mt-5">

                            {
                                result ?
                                    <button
                                        disabled={!result}
                                        className="button_search col-5"
                                        onClick={() => handleDownload(result)}
                                    >
                                    DoiSoatLienThongBaiDo.XLSX
                                    </button> :
                                    <div></div>
                            }
                        </div>
...
export default DoiSoatLienThongBaiDo;
