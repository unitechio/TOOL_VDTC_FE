    ...
    function GiaoDichSMSVTQ() {
        ...
        const minDate = new Date(today.getTime() - 30 * 24 * 60 * 60 * 1000); // Ngày hiện tại trừ đi 1 ngày
        ...
        return (
            <div>
                ...
                <div className="container" style={{ textAlign: "left" }}>
                    <h2 className="text-center m-3">Giao dịch SMS VTQ DANTHE</h2>
