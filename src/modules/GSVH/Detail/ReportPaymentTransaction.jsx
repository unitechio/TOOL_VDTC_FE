...
function ReportPaymentTransaction() {
    ...
    */
    ...
    const handleSubmit = () => {
        ...
        if (startTime === "" || endTime === "" || endTime < startTime ) {
            ...
            axios
                .get(
                    `${urlBase}/api/gsvh/get-report-by-many-sql?startTime=${startTime}&endTime=${endTime}&optionTool=${optionTool}`,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            "Content-Type": "multipart/form-data",
...
export default ReportPaymentTransaction;
