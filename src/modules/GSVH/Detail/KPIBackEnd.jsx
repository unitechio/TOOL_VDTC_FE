...
function KPIBackEnd() {
  ...
  */
  ...
  const handleSubmit = () => {
      ...
      axios
        .get(
          `${urlBase}/api/gsvh/kpi-backend?optionTool=${optionTool}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "multipart/form-data",
    ...
    <div>
      ...
      <div className="container">
        ...
        <div className="mt-5" style={{fontSize:"25px"}}>
            <dt>Lấy KPI BACKEND trong 7 ngày gần nhất</dt>
          <button
        ...
        <div id="download-button-sale-order">
          {result ? (
            <div>
              <p>Click down below to download KPI-BACKEND.XLSX</p>
              <button
                className="btn btn-info"
                onClick={() => handleDownload(result)}
              >
                Download KPI-BACKEND.XLSX
              </button>
            </div>
          ) : (
            ""
        ...
        <div className="mt-5" style={{ fontSize: "20px" }}>
          <dt>
          Lấy KPI BACKEND trong 7 ngày gần nhất - ấn submit.
            <dt>
