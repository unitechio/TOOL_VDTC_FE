...
function KPISanBay() {
    ...
    const minDate = new Date(today.getTime() - 1 * 24 * 60 * 60 * 1000); // Ngày hiện tại trừ đi 7 ngày
    ...
    */
    ...
    const handleSubmit = () => {
        ...
        if (startTime === "" || endTime === "" || endTime < startTime) {
            ...
            axios
                .get(
                    `${urlBase}/api/gsvh/kpi-san-bay?startTime=${startTime}&endTime=${endTime}`,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            "Content-Type": "multipart/form-data",
    ...
    return (
        <div>
            ...
            <div className="container" style={{ textAlign: "left" }}>
                <h2 className="text-center m-3">KPI Sân Bay</h2>
